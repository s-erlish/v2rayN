...
public class AppUpdateChannelTests
{
    ...
    {
        GitHub.LatestFeedUrl.Should().Be("https://api.github.com/repos/s-erlish/v2rayN/releases/latest");
        GitHub.ReleasesFeedUrl.Should().Be("https://api.github.com/repos/s-erlish/v2rayN/releases");
    ...
    [InlineData("http://api.github.com/repos/s-erlish/v2rayN/releases/latest")]
    [InlineData("https://api.github.com/repos/s-erlish/v2rayN/releases?per_page=100")]
    [InlineData("https://api.github.com/repos/s-erlish/v2rayN/releases/tags/v1.0.0")]
    [InlineData("https://api.github.com.evil.example/repos/s-erlish/v2rayN/releases")]
    ...
    public void DownloadsComeFromOurReleaseByTag()
    {
        GitHub.DownloadUrl("v1.2.0", AppUpdateChannel.AssetName).AbsoluteUri
            .Should().Be("https://github.com/s-erlish/v2rayN/releases/download/v1.2.0/departament-windows-x64.zip");
        GitHub.DownloadUrl("v1.2.0-rc.3", AppUpdateChannel.ChecksumAssetName).AbsoluteUri
            .Should().Be("https://github.com/s-erlish/v2rayN/releases/download/v1.2.0-rc.3/departament-windows-x64.zip.sha256");
    ...
    public void ForeignAssetsAndTagsNeverBecomeADownloadAddress(string tag, string asset)
    {
        ...
        GitHub.IsDownloadUrl(new Uri("https://github.com/s-erlish/v2rayN/releases/download/v1.2.0/departament-windows-x64.zip"), tag, asset)
            .Should().BeFalse();
    }
    ...
    [InlineData("https://raw.githubusercontent.com/s-erlish/v2rayN/main/departament.exe")]
    ...
    [InlineData("https://github.com/s-erlish/v2rayN/raw/main/departament.exe")]
    ...
    public void AMissingOrRelativeRedirectIsRefused()
    {
        ...
        GitHub.IsAllowedRedirect(new Uri("/s-erlish/v2rayN/releases/download/v1.2.0/departament-windows-x64.zip", UriKind.Relative))
            .Should().BeFalse();
    }
