...
public sealed partial class L
{
    partial void RegisterServers()
    {
        ...
        //  «Добавьте подписку» отправляло искать то, чего у человека нет; правильный следующий шаг —
        ...
        Add("Servers_EmptyHint", "Купите подписку — серверы появятся здесь сами", "Buy a subscription — the servers will show up here on their own");
