...
///
/// ВХОДА У ЭТОГО ЭКРАНА НЕТ — и это решение, а не недоделка. Метод пинга в настройках выбирается
/// ОКОШКОМ у значения, как и DNS; пункта «Ещё…» рядом с ним не будет. Файл оставлен целиком:
/// правило проекта — уточнять, а не удалять; экран приведён к общему лекалу и ждёт своего дня.
/// </summary>
